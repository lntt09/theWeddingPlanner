...
class EditPlanner extends React.Component {
  ...
  handleSubmit = async(e) => {
      ...
      const validUpdate = await this.props.updatePlanner(this.props.planner._id, this.state)
      if (validUpdate){
        this.toggle();
      }
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalBody className='modalbody'>
            <form onSubmit={this.handleSubmit}>
                First Name: <input type="text" name="first_name" onChange={this.handleChange} value={this.props.planner.first_name} /><br/><br/>
                Last Name: <input name="last_name" onChange={this.handleChange} value={this.props.planner.last_name}></input><br/><br/>
                Wedding Date: <input type="text" name="wedding_date" onChange={this.handleChange} value={this.props.planner.wedding_date} />
            </form>
          </ModalBody>
          <ModalFooter>
